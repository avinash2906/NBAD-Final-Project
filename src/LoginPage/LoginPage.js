    ...
    <section style={{ textAlign: 'center', padding: '20px', position: 'relative' }}>
      <section style={{ display: 'inline-block', textAlign: 'left', backgroundColor: '#f9f9f9', border: '1px solid #ccc', borderRadius: '10px', padding: '20px', width: '400px' }}>
        ...
        <form onSubmit={handleLogin}>
          ...
          />
          <br />
          <button type="submit" style={{ marginLeft: '5px', fontWeight: '800', letterSpacing: '0.1em', fontSize: '20px', backgroundColor: '#3498db', color: 'white', padding: '10px 15px', border: 'none', borderRadius: '5px', cursor: 'pointer', width: '100%' }}>
            Login
          </button>
        </form>
      </section>
