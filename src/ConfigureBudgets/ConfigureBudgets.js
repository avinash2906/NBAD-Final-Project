  ...
  return (
    <main className="center" id="main" aria-label="main">
      <div style={{ width: '300px', margin: 'auto'}}>
        ...
        <button type="button" onClick={handleAddBudget} style={{ backgroundColor: 'blue', color: 'white', padding: '10px 15px', border: 'none', borderRadius: '5px', cursor: 'pointer', width: '100%' }}>
          Add Budget
        </button>
        ...
        <button type="button" onClick={handleSaveBudgets} style={{ backgroundColor: 'blue', color: 'white', padding: '10px 15px', border: 'none', borderRadius: '5px', cursor: 'pointer', width: '48%', marginRight: '10px' }}>
          Save
        </button>
      </div>
    </main>
